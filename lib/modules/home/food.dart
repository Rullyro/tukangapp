...
double? width;
double? height;
final bodies = [Foodscreen(), Proses(), Terdaftar()];
...
class Food1 extends StatefulWidget {
  @override
  _Food1 createState() => _Food1();
}

class _Food1 extends State<Food1> {
                        ...
                        Expanded(
                          child: StreamBuilder(
                            stream: FirebaseFirestore.instance.collection('menu')
                                .where(FieldPath.documentId, isEqualTo: "food")
                                .snapshots(),
