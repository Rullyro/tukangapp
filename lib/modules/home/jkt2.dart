...
double? width;
double? height;
final bodies = [Jkt2screen(), Proses(), Terdaftar()];

class Jkt2 extends StatefulWidget {
  const Jkt2({Key? key}) : super(key: key);

  _Jkt2State createState() => _Jkt2State();
}

class _Jkt2State extends State<Jkt2> {
...
class Jkt2screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class Jkt22 extends StatefulWidget {
  @override
  _Jkt22 createState() => _Jkt22();
}

class _Jkt22 extends State<Jkt22> {
  String name = "";
  String pilihan = "";
  dynamic infouser;
                              ...
                              children: [
                                ...
                                FittedBox(
                                  ...
                                  child: SizedBox(
                                    width: 150,
                                    height: 200,
                                    child: Image.asset('img/jkt2.jpg'),
                                  ),
                                ),
                                SizedBox(height: 15,),
                                Text("Proyek Jakarta 2",
                                  style: TextStyle(
                                    color: Colors.black,
