...
double? width;
double? height;
final bodies = [Sby1screen(), Proses(), Terdaftar()];

class Sby1 extends StatefulWidget {
  const Sby1({Key? key}) : super(key: key);

  _Sby1State createState() => _Sby1State();
}

class _Sby1State extends State<Sby1> {
...
class Sby1screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class Sby11 extends StatefulWidget {
  @override
  _Sby11 createState() => _Sby11();
}

class _Sby11 extends State<Sby11> {
  String name = "";
  String pilihan = "";
  dynamic infouser;
                            ...
                            children: [
                              ...
                              FittedBox(
                                ...
                                child: SizedBox(
                                  width: 150,
                                  height: 200,
                                    child: Image.asset('img/sby1.jpg'),
                                  ),
                              ),
                              SizedBox(height: 15,),
                              Text("Proyek Surabaya 1",
                              style: TextStyle(
                                color: Colors.black,
