...
double? width;
double? height;
final bodies = [Sby2screen(), Proses(), Terdaftar()];

class Sby2 extends StatefulWidget {
  const Sby2({Key? key}) : super(key: key);

  _Sby2State createState() => _Sby2State();
}

class _Sby2State extends State<Sby2> {
...
class Sby2screen extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
...
class Sby22 extends StatefulWidget {
  @override
  _Sby22 createState() => _Sby22();
}

class _Sby22 extends State<Sby22> {
  String name = "";
  String pilihan = "";
  dynamic infouser;
                              ...
                              children: [
                                ...
                                FittedBox(
                                  ...
                                  child: SizedBox(
                                    width: 150,
                                    height: 200,
                                    child: Image.asset('img/sby2.jpg'),
                                  ),
                                ),
                                SizedBox(height: 15,),
                                Text("Proyek Surabaya 2",
                                  style: TextStyle(
                                    color: Colors.black,
