...
class _MyAppState extends State<MyApp> {
  ...
  void initState() {
    super.initState();
    _requestPermission();
    location.changeSettings(interval: 300, accuracy:
  ...
  _getLocation() async {
    try {
      ...
      await
      FirebaseFirestore.instance.collection('geographic').add({
  ...
  Future<void> _listenLocation() async {
    _locationSubscription = location.onLocationChanged.handleError((onError) {
      ...
      await
      FirebaseFirestore.instance.collection('geographic').doc('user').set({
